...
const projectData = {
  'real-estate-club': {
    ...
    overview: `The Real Estate Club GVSU Website is a platform designed to streamline the management and dissemination of information for the Real Estate Club at Grand Valley State University.
      The frontend is built using React, which offers a dynamic and responsive user interface, ensuring an optimal user experience across various devices.
      ...
      - Real-Time Updates: Firestore integration for instant reflection of changes made through the admin access.
    ...
    screens: [
      ...
      { imgSrc: syndicationImg, title: 'Syndication Project Screen:', description: 'The Syndication Project screen details an overview of the syndication project and the steps to become an analyst of the Real Estate Club, as well as informaitonal articles and videos.' },
      ...
      { imgSrc: aboutImg, title: 'Leadership Screen:', description: 'The Leadership screen provides general information about the club and introductions to the members of the executive board.' },
  ...
  'pygame-platformer': {
    ...
    overview: `This Ninja Platformer is a side-scrolling game built using Python and Pygame, this project allowed me to expirement with animations, particles, cameras, projectiles, sound effects and more. The game features multiple levels with increasing difficulty, various obstacles, and enemies to challenge the player.
      - OOP Structure: Developed using OOP principles and inheritence, ensuring scalable and easily maintainable code.
      - Multiple Levels: Features progressively challenging levels with a variety of obstacles and enemies.
      - Custom Assets: All visual assets and animations were created in Aseprite.
      - Sound Design: Sound effects were all self recorded, background music was open source on Upbeat.
      - Web Deployment: Deployed using Pygbag for playabillity in browser, making the game easily accessible without a downloadable executable.`,
        ...
        <div className="mt-4 mx-auto" style={{ maxWidth: '735px' }}>
          ...
          <div className="controls mt-8 flex items-center justify-around space-x-12">
            <div className="control-item flex flex-col items-center">
              ...
              <div className="flex flex-col items-center">
                <div className="flex justify-center items-center mb-2">
                  <img src={project.controls.arrowKeys[0]} alt="Up Key" className="w-8 h-8" />
                </div>
                <div className="flex justify-center items-center space-x-1">
                  <img src={project.controls.arrowKeys[2]} alt="Left Key" className="w-8 h-8" />
                  <img src={project.controls.arrowKeys[1]} alt="Down Key" className="w-8 h-8" />
                  <img src={project.controls.arrowKeys[3]} alt="Right Key" className="w-8 h-8" />
                </div>
              </div>
            </div>
            <div className="control-item flex flex-col items-center">
            ...
            <div className="control-item flex flex-col items-center">
              ...
              <img src={project.controls.escKey} alt="Escape" className="w-18 h-16 mt-2" />
            </div>
          </div>
        </div>
      )}
...
{project.screens.map((screen, index) => (
  <div key={index} className={`image-text-container flex items-center mt-4 ${index % 2 === 0 ? '' : 'flex-row-reverse'}`}>
    ...
    <div>
      <h4 className="text-lg font-bold text-3xl pb-2">{screen.title}</h4>  {/* Increased font size and added padding */}
